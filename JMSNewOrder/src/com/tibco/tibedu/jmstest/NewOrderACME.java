...
public class NewOrderACME {
		...
		public static void main(String[] args) {
			...
			String CustomerID	= " <ns0:CustomerID>"+ args2[0] + "</ns0:CustomerID>";
			String ItemSKU	    = " <ns0:ItemSKU>" + args2[1] + "</ns0:ItemSKU>";
			String Quantity		= " <ns0:Quantity>" + args2[2] + "</ns0:Quantity>";
			String ItemSKU2	    = " <ns0:ItemSKU>" + args2[3] + "</ns0:ItemSKU>";
			String Quantity2	= " <ns0:Quantity>" + args2[4] + "</ns0:Quantity>";
